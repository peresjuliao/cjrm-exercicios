/*
01 - Neste diretório (bateria-de-exercicios-01), há um index.html vazio.
...
*/
// alert('"JS is Awesome!" em um alert no browser')
...
*/
console.log(`Ano de nascimento: ${myBirthYear}, Ano atual: ${currentYear}`);
